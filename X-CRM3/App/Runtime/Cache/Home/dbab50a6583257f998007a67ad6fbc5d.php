...
<form id="pagerForm" data-toggle="ajaxsearch" action="/index.php?s=/Home/Wendangs" method="post">
...
<td><?php echo (substr($v["addtime"],0,10)); ?></td>
		   ...
		   <?php if(display(CONTROLLER_NAME.'/view')){ ?><td><a href="/index.php?s=/Home/Wendangs/view/id/<?php echo ($v['id']); ?>/navTabId/<?php echo CONTROLLER_NAME;?>"  data-toggle="dialog" data-width="900" data-height="500" data-id="dialog-mask" data-mask="true" >详细</a></td><?php } ?>
		   </td>

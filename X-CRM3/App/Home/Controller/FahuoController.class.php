...
class FahuoController extends CommonController{
  ...
  public function _befor_update($data){
   ...
   public function outxls() {
		...
		$list = $model->where($map)->field('id,hid,bianhao,mingcheng,title,shijian,value,beizhu,jingban')->select();
	    $headArr=array('ID','合同ID','合同编号','合同名称','客户名称','发货时间','物流快递','备注说明','经办人');
	    $filename='发货记录';

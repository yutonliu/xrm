...
class RukusController extends CommonController{
 ...
 $this->assign('shenhelist', $shenhelist); 
  ...
  public function _befor_update($data){
   ...
   public function outxls() {
		...
		$list = $model->where($map)->field('id,bianhao,title,fenlei,type,danwei,shuliang,beizhu,jingban,shijian,shenhe,xid,edit')->select();
	    $headArr=array('ID','产品编号','产品名称','产品分类','产品规格','计量单位','入库数量','备注','经办人','入库时间','审核状态','相关ID','是否编辑');
	    $filename='入库明细表';

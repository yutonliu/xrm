...
<body>
	...
	<header id="bjui-header" style="height:50px;">
        <div class="bjui-navbar-header">
            ...
            <a class="bjui-navbar-logo"  style="font-size:20px;color:#fff;line-height:45px;"><?php echo (C("WEB_SITE_TITLE")); ?><span style="font-size:12px"><?php echo (C("WEB_VER")); ?></span><!--<img src="/Public/images/logo.png">--></a>
        </div>
